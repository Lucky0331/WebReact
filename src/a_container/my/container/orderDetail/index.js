...
class HomePageContainer extends React.Component {
  ...
  showAlert = (obj) => {
        const alertInstance = alert("确认删除订单？", "删除之后将无法再查看订单", [
      ...
      <div className="page-order-detail">
        ...
        <div className="card-box">
          <div
            ...
            onClick={() => this.onGotoProduct(data, o.modelType)}
          >
            ...
            case 0:
              return (
                <div className="thefooter page-flex-row flex-ai-center flex-jc-end">
                  ...
                  <a className="blue" onClick={() => this.onPay()}>
                    立即支付
                  </a>
                </div>
              );
            case 4:
              return (
                <div className="thefooter page-flex-row flex-ai-center flex-jc-end">
                  <a onClick={() => this.onDel()}>删除订单</a>
                  {type === 5 ? (
                    <a className="blue" onClick={() => this.onLook()}>
                      {this.props.orderInfo.modelType === "M"
                        ? "查看优惠卡"
                        : "查看评估卡"}
                    </a>
                  ) : null}
